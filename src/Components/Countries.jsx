...
export const Countries = ({ country, setCountry }) => {
  return (
    <select
      id="country"
      name="country"
    ...
    >
      ...
      <option value="Cota D'Ivoire">Cote d&rsquo;Ivoire</option>
      ...
      <option value="Lao">Lao People&rsquo;s Democratic Republic</option>
